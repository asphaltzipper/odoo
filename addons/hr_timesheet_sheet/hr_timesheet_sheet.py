                    ...
                    FROM
                        ((
                            ...
                            select
                                ...
                                max(coalesce(o.inum,0)) as orphan_attendances,
                            ...
                            from
                                ...
                                ) as o ON o.inum=1 and o.o_action='sign_in' and o.employee_id=a.employee_id and o.nameday=(a.name AT TIME ZONE 'UTC' AT TIME ZONE tz.timezone)::date
